...
(function(global, r)
{
    ...
    nice.api.queue.CommandState = Slice.defineEnum({
        'QUEUED':0, 'RUNNING':1, 'CHILDREN':2, 'FINISHED':3, 'SKIPPED':4});
    ...
    nice.api.queue.CommandError = Slice.defineObject(
        function(message, eventLevel, eventID)
        {
            ...
            this.eventLevel = eventLevel !== undefined ? eventLevel : nice.api.events.INFO;
    ...
    nice.api.queue.CommandStatus = Slice.defineStruct(
        ...
        {
            this.state = state !== undefined ? state : nice.api.queue.QUEUED;
            this.commandStr = commandStr !== undefined ? commandStr : null;
            this.isBreakPoint = isBreakPoint !== undefined ? isBreakPoint : false;
            this.metaState = metaState !== undefined ? metaState : null;
    ...
    nice.api.queue.BaseQueueNode = Slice.defineObject(
        function(UUID, parentUUID, children)
        {
            ...
            this.parentUUID = parentUUID !== undefined ? parentUUID : null;
    ...
    nice.api.queue.QueueNode = Slice.defineObject(
        ...
        function(__is)
        {
            this.origin = nice.api.SessionId.read(__is);
            this.status = nice.api.queue.CommandStatus.read(__is);
        },
        false);
