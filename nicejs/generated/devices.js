...
(function(global, r)
{
    ...
    nice.api.devices.NodeStatusValue = Slice.defineObject(
        function(userVal, userUnit, internalVal, internalUnit, validity, validityString, timeStampAfter)
        {
            ...
            this.userUnit = userUnit !== undefined ? userUnit : null;
            this.internalVal = internalVal !== undefined ? internalVal : null;
            this.internalUnit = internalUnit !== undefined ? internalUnit : null;
    ...
    nice.api.devices.NodeRecord = Slice.defineObject(
        function(id, nodeID, deviceID, description, userUnit, internalUnit, userPrecision, storageMode, isStored, isUnitRelative, isUserLocked, isAdminLocked, desiredValue, currentValue, dataType, writeOnSync, hasControlInput)
        {
            ...
            this.nodeID = nodeID !== undefined ? nodeID : null;
            ...
            this.storageMode = storageMode !== undefined ? storageMode : nice.api.data.NONE;
            ...
            this.dataType = dataType !== undefined ? dataType : null;
    ...
    Slice.defineDictionary(nice.api.devices, "NodeMap", "NodeMapHelper", "Ice.StringHelper", "Ice.ObjectHelper", false, false, "nice.api.devices.NodeRecord");
    ...
    nice.api.devices.DeviceRecord = Slice.defineObject(
        function(id, displayName, description, primaryNodeID, stateNodeID, brokenNodeID, type, visibleNodeIDs)
        {
            ...
            this.description = description !== undefined ? description : null;
            this.primaryNodeID = primaryNodeID !== undefined ? primaryNodeID : null;
            this.stateNodeID = stateNodeID !== undefined ? stateNodeID : null;
            this.brokenNodeID = brokenNodeID !== undefined ? brokenNodeID : null;
            this.type = type !== undefined ? type : nice.api.data.TEST_TYPE;
    ...
    Slice.defineDictionary(nice.api.devices, "DeviceMap", "DeviceMapHelper", "Ice.StringHelper", "Ice.ObjectHelper", false, false, "nice.api.devices.DeviceRecord");
