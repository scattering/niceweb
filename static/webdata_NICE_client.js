...
webData.prototype.processRecord = function(record) {
    ...
    } else if (record.command == 'enddata' || record.command == 'End') {
        data_ended = true;
    ...
    } else if (record.command == 'Counts') {
        //in_datastream = true;
        console.log('Counts', record);
        this.addCounts(lineid, record.data);
        if ('eta' in record) { $('#'+this.plotdiv+'_eta').html("<b>ETA: </b>" + String(record.eta)); }
    } else if (record.command == 'State') {
        //in_datastream = true;
        console.log('State', record);
        this.addState(lineid, record.data);
        if ('eta' in record) { $('#'+this.plotdiv+'_eta').html("<b>ETA: </b>" + String(record.eta)); }
    } else if (record.command == 'reset') {
        //in_datastream = true;
        this.resetData(record);
    } else if (record.command == 'Open') {
